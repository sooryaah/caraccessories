...
const ProductTable = () => {
  ...
  // ✅ Reusable fetch function with safe array handling
  const fetchProductcategorylist = async () => {
    try {
      ...
      setProductcategorylist([]); // prevent undefined
    }
  };
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden mr-4 sm:mr-6 md:mr-10 lg:mr-16 xl:mr-20 2xl:mr-24">
      <div className="overflow-x-auto max-h-60 overflow-y-auto scrollbar-none">
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Disable</th>
            </tr>
          </thead>
          <tbody>
