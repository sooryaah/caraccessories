                ...
                <div className="bg-white shadow rounded  p-5">
                    <div className='flex justify-between items-center'>
                        <div className='flex gap-8 items-center '>
                            ...
                            <p className='font-medium lg:text-lg sm:text-sm '>Emily T</p>
                            <span className=" lg:text-lg sm:text-sm font-medium text-[#5737B4] ">Bosch Car Battery</span>
                            <p className="lg:text-lg sm:text-sm text-gray-700">Date : 20 May 2025, Time : 3:20 PM</p>
                        </div>
                        <div className="bg-[#5737B4] text-white rounded-lg px-2.5 py-2 cursor-pointer lg:text-md sm:text-sm ">Replay to Review</div>
                    </div>
                    ...
                    <p className='lg:w-3xl sm:w-lg'>Excellent battery backup. My car starts instantly even on cold mornings. Highly recommended! Excellent battery backup. My car starts instantly even on cold mornings.</p> <Link className='text-[#5737B4] font-thin'>View more!</Link>
                </div>
                <div className="bg-white shadow rounded  p-5">
                    <div className='flex justify-between items-center'>
                        <div className='flex gap-8 items-center '>
