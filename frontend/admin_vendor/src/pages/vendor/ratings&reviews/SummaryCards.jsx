...
const SummaryCards = () => {
    return (
        <div className='flex gap-6'>
            {/* Total Reviews Card */}
            <div className='bg-white w-md p-6 rounded-xl shadow'>
                <div className='flex items-center gap-2 font-semibold '>
                    <BsStar /> Total Reviews
                </div>
                <div className='text-xl font-bold mb-6'>43 <span className='text-red-500 text-sm'>(-12.6%)</span></div>
                <div className='h-48'>
            ...
            {/* Total Ratings Card */}
            <div className='bg-white w-2xl p-6 rounded-xl shadow'>
                <div className='flex gap-2 items-center font-semibold mb-6'><BsStar/>Total Ratings</div>
